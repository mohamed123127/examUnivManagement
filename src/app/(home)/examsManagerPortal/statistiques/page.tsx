          ...
          <div className='flex justify-between w-full mt-16 space-x-48 px-32'>
            ...
            <div className='flex flex-col items-center'>
              <PieChart
                series={[
                  {
                    data: examPerDept.map((raw)=>({id:raw.department_id,value:raw.examPerDept, label:'Department ' + raw.department_id})),
                  },
                ]}
                width={300}
                height={300}
              />
              <h3 className='text-xl text-center font-bold mr-16'>Répartition des examens par département</h3>
            </div>
          </div>
        </div>
  )
